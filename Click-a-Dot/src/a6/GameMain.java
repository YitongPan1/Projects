...
public class GameMain {
    ...
    private static JComponent makeSliderPanel(JSlider slider, String title) {
        ...
        // the heading "Setting the Layout Manager" for example code that you can adapt.
        // 2. Add an EmptyBorder around the panel to provide at least 4px of padding on all sides.
        // Use an overload of `BorderFactory.createEmptyBorder` [2] to create the border.
        ...
        // 4. Add `slider` to the panel to fill the remaining space below the label.
        // 5. Return the panel.
        ...
        if(returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try (PrintWriter out =
                ...
                JOptionPane.showMessageDialog(frame, e.getClass()+ " " + e.getMessage(),
                        String.valueOf(e.getClass()), JOptionPane.ERROR_MESSAGE);
            }
        }
