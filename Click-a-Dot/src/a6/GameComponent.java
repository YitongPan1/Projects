...
public class GameComponent extends JPanel implements MouseListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        if(isActive){
            ...
            target.paintDot(g);
            g.drawArc(target.x, target.y, target.radius, target.radius, 0, 360);
        }
        else{
            g.setColor(Color.BLACK);
            int w = getWidth();
    ...
    private static class Target {
         ...
         * circular area and if it was not already "hit"; return false otherwise.
         */
